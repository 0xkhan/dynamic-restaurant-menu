...
new (0, _controllerDefault.default)({
    tab: "menu__tab",
    tabsContainer: "menu__tabs",
    contentContainer: "menu__content"
});

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./js/Controller":"9mAZ4"}],"gkKU3":[function(require,module,exports) {
...
},{}],"9mAZ4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Controller {
    ...
    async controlMenu() {
        try {
            (0, _viewDefault.default).renderSpinner();
            await (0, _modelDefault.default).loadMenuData();
            (0, _viewDefault.default).renderCatBar((0, _modelDefault.default).state.menuCategories);
            (0, _viewDefault.default).render((0, _modelDefault.default).state);
        } catch (err) {
            console.error(err);
            (0, _viewDefault.default).renderError();
        }
    }
    init() {
        (0, _viewDefault.default).addHandlerMenu(this.controlMenu, this.#domSelectors);
    }
}
exports.default = Controller;

},{"./Model":"lOKu8","./View":"aNaCY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lOKu8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Model {
    state = {
        menuCategories: (0, _configJs.MENU_CATS),
        menu: {}
    };
    async loadMenuData() {
        try {
            const data = await (0, _helpersJs.AJAX)((0, _configJs.API_URL));
...
parcelHelpers.export(exports, "MENU_CATS", ()=>MENU_CATS);
...
},{"./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aNaCY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class View {
    #data;
    ...
    #generateMarkup(data, cat1, firstCat1) {
        return `
            <div class="menu__content ${cat1 === firstCat1 ? "menu__content--active" : ""} menu__content--${cat1}">
                <div class="row">
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire91fe")
